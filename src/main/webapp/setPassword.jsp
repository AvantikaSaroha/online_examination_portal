			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form action="/online_exam_portal/DoneSetPassword" class="signin-form" method="post">
							<div class="form-group mt-3">
			      			<input name="email" type="hidden" value="<c:out value="${email}"/>" class="form-control" required>
			      		</div>
			      		<div class="form-group mt-3">
		            ...
		            <div class="form-group">
		            	<button type="submit" class="form-control btn btn-primary rounded submit px-3">Set Password</button>
		            </div>
